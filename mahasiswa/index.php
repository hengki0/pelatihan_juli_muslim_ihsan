...
$data = mysqli_query($conn, "SELECT * FROM mahasiswa INNER JOIN porodi ON mahasiswa.prodi_id = porodi.prodi_id ORDER BY mhs_id DESC");
// var_dump($data);

$dataprodi = mysqli_query($conn, "SELECT * FROM porodi");
?>
<!DOCTYPE html>
<html lang="en">
...
<nav class="bg-white border-gray-200 dark:bg-gray-900 shadow-sm">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/pelatihan/index.php" class="flex items-center space-x-3 rtl:space-x-reverse">
